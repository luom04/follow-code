...
if ($id) {
    /* Lấy tag detail */
    $tags_detail = $d->rawQueryOne("select id, name$lang, desc$lang, content$lang, type, photo, slugvi, slugen, options from #_tags where id = ? and type = ? limit 0,1", array($id, $type));
