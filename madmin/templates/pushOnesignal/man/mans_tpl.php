<?php
$linkMan = "pushOnesignal?act=man";
$linkAdd = "pushOnesignal?act=add";
$linkEdit = "pushOnesignal?act=edit";
$linkDelete = "pushOnesignal?act=delete";
?>
<!-- Content Header -->
                        ...
                        <?php for ($i = 0; $i < count($items); $i++) { ?>
                            <tr>
                                ...
                                <td class="align-middle text-center text-md text-nowrap">
                                    <a class="btn btn-sm bg-gradient-success text-white" id="push-onesignal" data-url="pushOnesignal?act=sync&id=<?= $items[$i]['id'] ?>" title="Đẩy tin"><i class="fas fa-paper-plane mr-2"></i><?=daytin?></a>
                                </td>
                                <td class="align-middle text-center text-md text-nowrap">
