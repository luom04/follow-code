...
$linkAdd = "newsletter?act=add&type=" . $type;
$linkEdit = "newsletter?act=edit&type=" . $type;
$linkDelete = "newsletter?act=delete&type=" . $type;
?>
<!-- Content Header -->
            ...
            <table class="table table-hover">
                <thead>
                    <tr>
                        ...
                        <?php if (isset($config['newsletter'][$type]['show_subject']) && $config['newsletter'][$type]['show_subject'] == true) { ?>
                    ...
                    <tbody>
                        <?php for ($i = 0; $i < count($items); $i++) { ?>
                            <tr>
                                ...
                                <?php if (isset($config['newsletter'][$type]['show_subject']) && $config['newsletter'][$type]['show_subject'] == true) { ?>
                                    <td class="align-middle">
                                        <a class="text-dark text-break" href="<?= $linkEdit ?>&id=<?= $items[$i]['id'] ?>" title="<?= $items[$i]['subject'] ?>"><?= $items[$i]['subject'] ?></a>
                                    </td>
                                <?php } ?>
                                <?php if (isset($config['newsletter'][$type]['show_name']) && $config['newsletter'][$type]['show_name'] == true) { ?>
                                    <td class="align-middle">
