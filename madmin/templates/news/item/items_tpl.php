<?php
$linkMan = $linkFilter = "news?act=man_item&type=" . $type;
$linkAdd = "news?act=add_item&type=" . $type;
$linkEdit = "news?act=edit_item&type=" . $type;
$linkDelete = "news?act=delete_item&type=" . $type;
?>
<!-- Content Header -->
