<?php
$linkMan = "news?act=man_item&type=" . $type;
if ($act == 'add_item') $linkFilter = "news?act=add_item&type=" . $type;
else if ($act == 'edit_item') $linkFilter = "news?act=edit_item&type=" . $type . "&id=" . $id;
$linkSave = "news?act=save_item&type=" . $type;
?>
<!-- Content Header -->
