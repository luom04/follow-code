<?php
$linkMan = $linkFilter = "news?act=man_cat&type=" . $type;
$linkAdd = "news?act=add_cat&type=" . $type;
$linkEdit = "news?act=edit_cat&type=" . $type;
$linkDelete = "news?act=delete_cat&type=" . $type;
?>
<!-- Content Header -->
