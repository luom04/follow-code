<?php
$linkMan = "news?act=man_list&type=" . $type;
$linkSave = "news?act=save_list&type=" . $type;
...
if ((isset($config['news'][$type]['images_list']) && $config['news'][$type]['images_list'] == true) || (isset($config['news'][$type]['icon_list']) && $config['news'][$type]['icon_list'] == true)) {
    $colLeft = "col-xl-8";
    $colRight = "col-xl-4";
} else {
    $colLeft = "col-12";
                                        ...
                                        <div class="tab-pane fade show <?= ($k == 'vi') ? 'active' : '' ?>" id="tabs-lang-<?= $k ?>" role="tabpanel" aria-labelledby="tabs-lang">
                                            ...
                                            <?php if (isset($config['news'][$type]['content_list']) && $config['news'][$type]['content_list'] == true) { ?>
                                                <div class="form-group">
                                                    ...
                                                    <button class="content-with-ai" data-lang="<?= $k ?>" data-com="<?=$com?>">Viết AI</button>
                ...
                <?php if (isset($config['news'][$type]['icon_list']) && $config['news'][$type]['icon_list'] == true) { ?>
                    <div class="card card-primary card-outline text-sm">
                        ...
                        <div class="card-body">
                            ...
                            $photoDetail1['dimension'] = "Width: " . $config['news'][$type]['width_icon_list'] . " px - Height: " . $config['news'][$type]['height_icon_list'] . " px (" . $config['news'][$type]['img_type_list'] . ")";
                            /* Image */
