...
$linkAdd = "news?act=add_list&type=" . $type;
$linkEdit = "news?act=edit_list&type=" . $type;
$linkDelete = "news?act=delete_list&type=" . $type;
$linkMulti = "news?act=man_photo&kind=man_list&type=" . $type;
?>
<!-- Content Header -->
