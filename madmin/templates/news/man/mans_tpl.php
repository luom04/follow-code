<?php
$linkView = $configBase;
$linkMan = $linkFilter = "news?act=man&type=" . $type;
$linkAdd = "news?act=add&type=" . $type;
$linkCopy = "news?act=copy&type=" . $type;
$linkEdit = "news?act=edit&type=" . $type;
$linkDelete = "news?act=delete&type=" . $type;
$linkMulti = "news?act=man_photo&kind=man&type=" . $type;
$linkComment = "comment?act=man&variant=news&type=" . $type;
...
<section class="content">
    <div class="card-footer text-sm sticky-top">
        ...
        <div class="d-inline-block ml-3 total-text">Có <b class="text-danger">(<?=$total?>)</b> <?= $config['news'][$type]['title_main'] ?></div>
    </div>
                    ...
                    <tbody>
                        <?php for ($i = 0; $i < count($items); $i++) {
                            ...
                            <tr>
                                ...
                                <?php } ?>
                                <td class="align-middle">
                                    <a class="text-dark text-break" href="<?= $linkEdit ?><?= $linkID ?>&id=<?= $items[$i]['id'] ?>" title="<?= $items[$i]['namevi'] ?>"><?= htmlspecialchars_decode($items[$i]['namevi']) ?></a>
                                ...
                                <?php if (isset($config['news'][$type]['position']) && count($config['news'][$type]['position']) > 0) { ?>
                                    <td class="align-middle"><?=$config['news'][$type]['position'][$items[$i]['position']]?></td>
                                <?php } ?>
