<?php
$linkMan = "news?act=man_sub&type=" . $type;
if ($act == 'add_sub') $linkFilter = "news?act=add_sub&type=" . $type;
else if ($act == 'edit_sub') $linkFilter = "news?act=edit_sub&type=" . $type . "&id=" . $id;
$linkSave = "news?act=save_sub&type=" . $type;
?>
<!-- Content Header -->
