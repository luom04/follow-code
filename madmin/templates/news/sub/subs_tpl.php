<?php
$linkMan = $linkFilter = "news?act=man_sub&type=" . $type;
$linkAdd = "news?act=add_sub&type=" . $type;
$linkEdit = "news?act=edit_sub&type=" . $type;
$linkDelete = "news?act=delete_sub&type=" . $type;
?>
<!-- Content Header -->
