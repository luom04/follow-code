<?php
$linkSave = "photo?act=save_static&type=" . $type;
        ...
        <div class="card card-primary card-outline text-sm">
            ...
            <div class="card-body">
                        ...
                        <div class="upload-file">
                            ...
                            <label class="upload-file-label mb-2" for="file">
                                <div class="upload-file-image rounded mb-3">
                                    <?php /* $func->getImage(['class' => 'rounded img-upload', 'sizes' => $config['photo']['photo_static'][$type]['thumb'], 'upload' => UPLOAD_PHOTO_L, 'image' => (!empty($item['photo'])) ? $item['photo'] : '', 'alt' => 'Alt Photo']) */ ?>
                                    <img src="<?= UPLOAD_PHOTO.$item['photo'] ?>" class="rounded img-upload" alt="Alt Photo">
                ...
                <div class="row">
                    ...
                    <?php if (isset($config['photo']['photo_static'][$type]['file_video']) && $config['photo']['photo_static'][$type]['file_video'] == true) { ?>
                        <div class="form-group">
                            <div class="upload-file mb-2">
                                <div class="mb-3"><?="Upload Video"?></div>
                                <div class="show-video">
                                    <video controls>
                                        <source src="<?=UPLOAD_FILE.@$item['file_video']?>" id="video_here">
                                        Your browser does not support HTML5 video.
                                    </video>
                                </div>
                                <div>
                                    <label class="upload-file-label mb-2" for="file_video">
                                        <div class="custom-file my-custom-file">
                                            <input type="file" class="custom-file-input file_upload_video" name="file_video" accept="video/mp4,video/x-m4v,video/*">
                                            <label class="custom-file-label mb-0" data-browse="Chọn" for="file_video"><?=chonfile?></label>
                                        </div>
                                    </label>
                                </div>
                                <strong class="text-sm"><?= $config['photo']['photo_static'][$type]['file_type_video'] ?></strong>
                            </div>
                        </div>
                    <?php } ?>
                </div>
