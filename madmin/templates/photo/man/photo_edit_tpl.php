<?php
$linkMan = "photo?act=man_photo&type=" . $type;
$linkSave = "photo?act=save_photo&type=" . $type;
?>
<!-- Content Header -->
    ...
    <form class="validation-form" novalidate method="post" action="<?= $linkSave ?>" enctype="multipart/form-data">
        ...
        <div class="card card-primary card-outline text-sm">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    <div class="show-video" style="max-width: 500px;">
                        <video controls>
                            <source src="<?=UPLOAD_PHOTO.$item['link_video']?>" id="video_here">
                ...
                <?php } ?>
                <div class="form-group">
                    <div class="upload-file" style="max-width: 300px;">
                        <label class="d-block">Upload video: <strong class="text-danger text-sm">(<?= $config['photo']['man_photo'][$type]['video_type'] ?>)</strong></label>
