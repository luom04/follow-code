<?php
$linkView = $configBase;
$linkMan = $linkFilter = "product?act=man&type=" . $type;
$linkAdd = "product?act=add&type=" . $type;
$linkCopy = "product?act=copy&type=" . $type;
$linkEdit = "product?act=edit&type=" . $type;
$linkDelete = "product?act=delete&type=" . $type;
$linkMulti = "product?act=man_photo&kind=man&type=" . $type;
$linkComment = "comment?act=man&variant=product&type=" . $type;
...
<section class="content">
    <div class="card-footer text-sm sticky-top">
        ...
        <div class="d-inline-block ml-3 total-text">Có <b class="text-danger">(<?=$total?>)</b> sản phẩm</div>
    </div>
    <?php if (
        ...
        <div class="card-footer form-group-category text-sm  row">
                ...
                <?php } else { ?>
                    <tbody>
                        <?php for ($i = 0; $i < count($items); $i++) {
                            ...
                            if ($items[$i]['id_ward']) $linkID .= "&id_ward=" . $items[$i]['id_ward'];
                            ?>
