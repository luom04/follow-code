...
$linkAdd = "product?act=add_attr&type=" . $type;
$linkEdit = "product?act=edit_attr&type=" . $type;
$linkDelete = "product?act=delete_attr&type=" . $type;
?>
<!-- Content Header -->
                    ...
                    <tbody>
                        <?php for ($i = 0; $i < count($items); $i++) { ?>
                            <tr>
                                ...
                                <td class="align-middle">
                                    <input type="number" class="form-control form-control-mini m-auto update-numb" min="0" value="<?= $items[$i]['numb'] ?>" data-id="<?= $items[$i]['id'] ?>" data-table="attributes">
                                </td>
                                <td class="align-middle">
                                ...
                                <?php if (isset($config['product'][$type]['check_attr'])) {
                                    foreach ($config['product'][$type]['check_attr'] as $key => $value) { ?>
                                        <td class="align-middle text-center">
                                            <div class="custom-control custom-checkbox my-checkbox">
                                                <input type="checkbox" class="custom-control-input show-checkbox" id="show-checkbox-<?= $key ?>-<?= $items[$i]['id'] ?>" data-table="attributes" data-id="<?= $items[$i]['id'] ?>" data-attr="<?= $key ?>" <?= (in_array($key, $status_array)) ? 'checked' : '' ?>>
