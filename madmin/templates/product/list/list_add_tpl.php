<?php
$linkMan = "product?act=man_list&type=" . $type;
$linkSave = "product?act=save_list&type=" . $type;
                ...
                <?php if (isset($config['product'][$type]['icon_list']) && $config['product'][$type]['icon_list'] == true) { ?>
                    <div class="card card-primary card-outline text-sm">
                        ...
                        <div class="card-body">
                            ...
                            $photoDetail1['dimension'] = "Width: " . $config['product'][$type]['width_icon_list'] . " px - Height: " . $config['product'][$type]['height_icon_list'] . " px (" . $config['product'][$type]['img_type'] . ")";
                            /* Image */
