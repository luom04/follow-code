...
$linkAdd = "product?act=add_list&type=" . $type;
$linkEdit = "product?act=edit_list&type=" . $type;
$linkDelete = "product?act=delete_list&type=" . $type;
$linkMulti = "product?act=man_photo&kind=man_list&type=" . $type;
?>
<!-- Content Header -->
