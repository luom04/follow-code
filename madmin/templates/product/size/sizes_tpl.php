...
$linkAdd = "product?act=add_size&type=" . $type;
$linkEdit = "product?act=edit_size&type=" . $type;
$linkDelete = "product?act=delete_size&type=" . $type;
?>
<!-- Content Header -->
            ...
            <table class="table table-hover">
                <thead>
                    <tr>
                        ...
                        <th class="align-middle text-center"><?=hienthi?></th>
                                ...
                                <?php if (isset($config['product'][$type]['size_images']) && $config['product'][$type]['size_images'] == true) { ?>
                                    <td class="align-middle">
                                        <a href="<?= $linkEdit ?>&id=<?= $items[$i]['id'] ?>" title="<?= $items[$i]['namevi'] ?>">
                                            <?= $func->getImage(['class' => 'rounded img-preview', 'sizes' => $config['product'][$type]['thumb_size'], 'upload' => UPLOAD_COLOR_L, 'image' => $items[$i]['photo'], 'alt' => $items[$i]['namevi']]) ?>
                                        </a>
                                    </td>
                                <?php } ?>
                                <td class="align-middle">
