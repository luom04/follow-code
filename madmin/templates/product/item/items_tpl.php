<?php
$linkMan = $linkFilter = "product?act=man_item&type=" . $type;
$linkAdd = "product?act=add_item&type=" . $type;
$linkEdit = "product?act=edit_item&type=" . $type;
$linkDelete = "product?act=delete_item&type=" . $type;
?>
<!-- Content Header -->
