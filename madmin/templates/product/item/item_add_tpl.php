<?php
$linkMan = "product?act=man_item&type=" . $type;
if ($act == 'add_item') $linkFilter = "product?act=add_item&type=" . $type;
else if ($act == 'edit_item') $linkFilter = "product?act=edit_item&type=" . $type . "&id=" . $id;
$linkSave = "product?act=save_item&type=" . $type;
?>
<!-- Content Header -->
