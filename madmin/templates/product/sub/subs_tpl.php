<?php
$linkMan = $linkFilter = "product?act=man_sub&type=" . $type;
$linkAdd = "product?act=add_sub&type=" . $type;
$linkEdit = "product?act=edit_sub&type=" . $type;
$linkDelete = "product?act=delete_sub&type=" . $type;
?>
<!-- Content Header -->
