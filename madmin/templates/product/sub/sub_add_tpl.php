<?php
$linkMan = "product?act=man_sub&type=" . $type;
if ($act == 'add_sub') $linkFilter = "product?act=add_sub&type=" . $type;
else if ($act == 'edit_sub') $linkFilter = "product?act=edit_sub&type=" . $type . "&id=" . $id;
$linkSave = "product?act=save_sub&type=" . $type;
?>
<!-- Content Header -->
