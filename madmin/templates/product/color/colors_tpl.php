<?php
$linkMan = "product?act=man_color&type=" . $type;
$linkAdd = "product?act=add_color&type=" . $type;
$linkEdit = "product?act=edit_color&type=" . $type;
$linkDelete = "product?act=delete_color&type=" . $type;
?>
<!-- Content Header -->
