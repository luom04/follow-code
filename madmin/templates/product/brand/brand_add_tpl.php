<?php
$linkMan = "product?act=man_brand&type=" . $type;
$linkSave = "product?act=save_brand&type=" . $type;
...
<section class="content">
    <form class="validation-form" novalidate method="post" action="<?= $linkSave ?>" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="<?= $colRight ?>">
            <?php if (
                    (isset($config['product'][$type]['list_brand']) && $config['product'][$type]['list_brand'] == true)
                ) { ?>
                    <div class="card card-primary card-outline text-sm">
                        <div class="card-header">
                            <h3 class="card-title">Danh mục <?= $config['product'][$type]['title_main_brand'] ?></h3>
                            <div class="card-tools">
                                <button type="button" class="btn btn-tool" data-card-widget="collapse"><i class="fas fa-minus"></i></button>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="form-group-category row">
                                <?php if (isset($config['product'][$type]['list_brand']) && $config['product'][$type]['list_brand'] == true) { ?>
                                    <div class="form-group col-xl-6 col-sm-4">
                                        <label class="d-block" for="id_list"><?=danhmuccap1?>:</label>
                                        <?= $func->getLists(@$item['id_lists']) ?>
                                    </div>
                                <?php } ?>
                            </div>
                        </div>
