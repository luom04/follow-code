<?php
$linkMan = $linkFilter = "product?act=man_cat&type=" . $type;
$linkAdd = "product?act=add_cat&type=" . $type;
$linkEdit = "product?act=edit_cat&type=" . $type;
$linkDelete = "product?act=delete_cat&type=" . $type;
?>
<!-- Content Header -->
