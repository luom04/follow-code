<?php
$linkMan = "places?act=man_ward";
if ($act == 'add_ward') $linkFilter = "places?act=add_ward";
else if ($act == 'edit_ward') $linkFilter = "places?act=edit_ward&id=" . $id;
$linkSave = "places?act=save_ward";
?>
<!-- Content Header -->
