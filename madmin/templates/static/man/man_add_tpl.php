<?php
$linkSave = "static?act=save&type=" . $type;
                                            ...
                                            <div class="tab-pane fade show <?= ($k == 'vi') ? 'active' : '' ?>" id="tabs-lang-<?= $k ?>" role="tabpanel" aria-labelledby="tabs-lang">
                                                ...
                                                <?php if (isset($config['static'][$type]['content']) && $config['static'][$type]['content'] == true) { ?>
                                                    <div class="form-group">
                                                        ...
                                                        <button type="button" class="content-with-ai" data-lang="<?= $k ?>" data-com="<?=$com?>">Viết Ai</button>
                                                        <?php } ?>
                        ...
                        <div class="form-group form-group-gallery">
                            ...
                            <div class="jFiler-items my-jFiler-items jFiler-row">
                                <ul class="jFiler-items-list jFiler-items-grid row scroll-bar" id="jFilerSortable">
                                    <?php foreach ($gallery as $v) echo $func->galleryFiler($v['numb'], $v['id'], $v['photo'], $v['namevi'], 'static', 'col-xl-2 col-lg-3 col-md-3 col-sm-4 col-6'); ?>
                                </ul>
                            </div>
                        </div>
                    <?php } ?>
