<?php
$linkMan = $linkFilter = "order?act=man";
$linkEdit = "order?act=edit";
$linkDelete = "order?act=delete";
$linkExcel = "excelAll";
$linkWord = "wordAll";
?>
<!-- Content Header -->
                                ...
                                <?php if (
                                    ...
                                    <td class="align-middle text-center text-lg text-nowrap">
                                        <?php if (isset($config['order']['excel']) && $config['order']['excel'] == true) { ?>
                                            <a class="text-primary mr-2" href="excel&id=<?= $items[$i]['id'] ?>" title="Xuất file excel"><i class="far fa-file-excel"></i></a>
                                        <?php } ?>
                                        <?php if (isset($config['order']['word']) && $config['order']['word'] == true) { ?>
                                            <a class="text-primary" href="word&id=<?= $items[$i]['id'] ?>" title="Xuất file word"><i class="far fa-file-word"></i></a>
                                        <?php } ?>
                                    </td>
                                <?php } ?>
