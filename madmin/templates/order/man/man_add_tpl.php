<?php
$linkMan = "order?act=man";
$linkSave = "order?act=save";
?>
<!-- Content Header -->
        ...
        <div class="card card-primary card-outline text-sm">
            ...
            <div class="card-body row">
                <div class="form-group col-md-4 col-sm-6">
                    ...
                    <p class="mb-0 text-primary"><?= @$item['code'] ?></p>
                </div>
                <div class="form-group col-md-4 col-sm-6">
                    <label><?=hinhthucthanhtoan?>:</label>
                    <?php $order_payment = $func->getInfoDetail('namevi', 'news', @$item['order_payment']); ?>
                    <p class="mb-0 text-info"><?= $order_payment['namevi'] ?></p>
                </div>
                <div class="form-group col-md-4 col-sm-6">
                    <label><?=hoten?>:</label>
                    <p class="mb-0 font-weight-bold text-uppercase text-success"><?= @$item['fullname'] ?></p>
                </div>
                <div class="form-group col-md-4 col-sm-6">
                ...
                <div class="form-group col-md-4 col-sm-6">
                    <label><?=ngaydat?>:</label>
                    <p class="mb-0"><?= date("h:i:s A - d/m/Y", @$item['date_created']) ?></p>
                </div>
                            ...
                            <?php foreach ($order_detail as $k => $v) { ?>
                                <tr>
                                    ...
                                    <td class="align-middle">
                                        ...
                                        <p class="mb-1">Mã sản phẩm: #<?= $v['code'] ?></p>
                                        <?php if ($v['attributes'] != '') { ?>
                                            <p class="mb-0"><?=$v['attributes']?></p>
                                        <?php } ?>
                                    </td>
