<?php
$linkMan = "user?act=permission_group";
$linkAdd = "user?act=add_permission_group";
$linkEdit = "user?act=edit_permission_group";
$linkDelete = "user?act=delete_permission_group";
?>
