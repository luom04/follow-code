...
$linkSave = "user?act=info_admin" . $changepass;
?>
<!-- Content Header -->
                ...
                <div class="row">
                    ...
                    <?php } else { ?>
                        ...
                        <div class="form-group col-xl-4 col-lg-6 col-md-6">
                            ...
                            <input type="text" class="form-control text-sm" name="data[address]" id="address" placeholder="<?=diachi?>" value="<?= (!empty($flash->has('address'))) ? $flash->get('address') : @$item['address'] ?>" />
                        </div>
                        <div class="col-xl-4">
                                ...
                                <div class="card-body">
                                    <?php if(isset($config['user']['images']) && $config['user']['images'] == true) { ?>
                                        ...
                                        <div class="form-group" id="avatar" > 
                                            ...
                                            $photoAction = 'avatar';
                                            $photoDetail['image'] = (!empty($item) && $act != 'copy') ? $item['avatar'] : '';
                                            $photoDetail['dimension'] = "Width: " . $config['user']['width'] . " px - Height: " . $config['user']['height'] . " px (" . $config['user']['img_type'] . ")";
                                            /* Image */
