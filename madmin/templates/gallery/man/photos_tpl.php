<?php
$linkParent = "" . $com . "?act=" . $kind . "&type=" . $type;
$linkMan = "" . $com . "?act=man_photo&id_parent=" . $id_parent . "&type=" . $type . "&kind=" . $kind . "&val=" . $val;
$linkAdd = "" . $com . "?act=add_photo&id_parent=" . $id_parent . "&type=" . $type . "&kind=" . $kind . "&val=" . $val;
$linkEdit = "" . $com . "?act=edit_photo&id_parent=" . $id_parent . "&type=" . $type . "&kind=" . $kind . "&val=" . $val;
$linkDelete = "" . $com . "?act=delete_photo&id_parent=" . $id_parent . "&type=" . $type . "&kind=" . $kind . "&val=" . $val;
?>
<!-- Content Header -->
                ...
                <thead>
                    <tr>
                        ...
                        <?php if (isset($config[$com][$type][$dfgallery][$val]['cart_photo']) && $config[$com][$type][$dfgallery][$val]['cart_photo'] == true) { ?>
                            <th class="align-middle text-capitalize"><?=mausac?></th>
                            <th class="align-middle text-capitalize"><?=kichthuoc?></th>
                        <?php } ?>
                        ...
                        <?php for ($i = 0; $i < count($items); $i++) { ?>
                            <tr>
                                ...
                                <?php if (isset($config[$com][$type][$dfgallery][$val]['cart_photo']) && $config[$com][$type][$dfgallery][$val]['cart_photo'] == true) { ?>
                                    ...
                                    <td class="align-middle">
                                        <?php $size_detail = $func->getInfoDetail('namevi', 'size', $items[$i]['id_size']); ?>
                                        <?= $size_detail['namevi'] ?>
                                    </td>
                                <?php } ?>
                                <?php if (isset($config[$com][$type][$dfgallery][$val]['file_photo']) && $config[$com][$type][$dfgallery][$val]['file_photo'] == true) { ?>
