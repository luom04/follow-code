<?php
$linkMan = "tags?act=man&type=" . $type;
$linkSave = "tags?act=save&type=" . $type;
        ...
        <div class="row">
            ...
            <div class="<?= $colRight ?>">
                <div class="card card-primary card-outline text-sm">
                    ...
                    <div class="card-body">
                        <?php if (isset($config['tags'][$type]['price_from']) && $config['tags'][$type]['price_from'] == true) { ?>
                            <div class="form-group">
                                <label class="d-block" for="price_from">Giá từ:</label>
                                <div class="input-group">
                                    <input type="text" class="form-control format-price text-sm" name="data[price_from]" id="price_from" placeholder="Giá từ" value="<?= (!empty($flash->has('price_from'))) ? $flash->get('price_from') : @$item['price_from'] ?>">
                        ...
                        <?php } ?>
                        <?php if (isset($config['tags'][$type]['price_to']) && $config['tags'][$type]['price_to'] == true) { ?>
                            <div class="form-group">
                                <label class="d-block" for="price_to">Giá đến:</label>
                                <div class="input-group">
                                    <input type="text" class="form-control format-price text-sm" name="data[price_to]" id="price_to" placeholder="Giá đến" value="<?= (!empty($flash->has('price_to'))) ? $flash->get('price_to') : @$item['price_to'] ?>">
                                    <div class="input-group-append">
                                        <div class="input-group-text"><strong>VNĐ</strong></div>
                                    </div>
                                </div>
