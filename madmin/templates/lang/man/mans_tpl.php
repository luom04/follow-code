<?php
$linkCreate = "lang?act=create&type=".$type;
$linkMan = "lang?act=man&type=".$type;
$linkAdd = "lang?act=add&type=".$type;
$linkEdit = "lang?act=edit&type=".$type;
$linkDelete = "lang?act=delete&type=".$type;
