			...
			<div class="card-body">
				...
				<div class="row">
					<?php if(isset($config['order']['coupon']) && $config['order']['coupon'] == true) { ?>
						<div class="form-group col-md-4 col-sm-6">
							<label for="soma">Số lượng mã khuyến mãi:</label>
							<input type="number" class="form-control" name="data[options][soma]" id="soma" placeholder="Số lượng mã tạo" value="<?=$options['soma']?>">
						</div>
					<?php } ?>
					...
					<?php if(isset($config['setting']['email']) && $config['setting']['email'] == true) { ?>
						<div class="form-group col-md-8 col-sm-6">
							...
							<label for="email">Email:<span class="text-primary font-weight-normal ml-1">Cách nhập nhiều mail (ex@gmail.com,ax@gmail.com...)</span></label>
					...
					<?php if(isset($config['setting']['time']) && $config['setting']['time'] == true) { ?>
						<div class="form-group col-md-4 col-sm-6">
							...
							<input type="text" class="form-control" name="data[options][time]" id="time" placeholder="Giờ làm việc" value="<?=$options['time']?>">
						</div>
					<?php } ?>
					<?php if(isset($config['setting']['hotline']) && $config['setting']['hotline'] == true) { ?>
						<div class="form-group col-md-4 col-sm-6">
							<label for="hotline">Hotline 1:</label>
							<input type="text" class="form-control" name="data[options][hotline]" id="hotline" placeholder="Hotline 1" value="<?=$options['hotline']?>">
						</div>
						<div class="form-group col-md-4 col-sm-6">
